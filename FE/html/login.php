        ...
        <div class="container-move">
            <div class="form-container sign-up">
                <form id="form">
                    ...
                    <div class="input-control">
                        <input type="text" placeholder="Họ Tên" class="txtName" id="input-box">
                        <div class="error"></div>
                    </div>
                    <div class="input-control">
                    ...
                    <div class="input-control">
                        <input type="text" placeholder="Số điện thoại" class="txtPhone" id="input-box">
                        <div class="error"></div>
                    </div>
                    <div class="input-control">
                        <input type="text" placeholder="Địa chỉ" class="txtAddress" id="input-box">
                        <div class="error"></div>
                    </div>
