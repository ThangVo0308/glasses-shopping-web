<div id="header">
    ...
    <div class="navigation">
        <a class="hover" href="#" onclick=changIframeHomeScreen()>Trang Chủ</a>
        <a class="hover" href="#" onclick=changIframeProducts()>Sản Phẩm</a>
    ...
    <div class="navigation">
        ...
        <img src="../../icons/user.png" alt="" id="Userlogin">
